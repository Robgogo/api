...
from .views import ListCreateSongsView, LoginView, RegisterUserView, SongsDetailView,null_view, complete_view
...
urlpatterns = [
    ...
    re_path('auth/register/account-email-verification-sent/',null_view,name="account_email_verification_sent"),
